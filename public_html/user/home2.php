...
<body class="grey lighten-3">
   <?php
   include_once('../assets/assets2.php');
   ...
   <main>
      <div class="container">
         <div class="card-panel left-div-margin" style="margin-top:14px">
            <h1 class="flow-text" style="margin:0 0 5px"><i class="material-icons left">home</i>Projeto Clínica</h1>
            <label>Sistema de Clínica</label>
