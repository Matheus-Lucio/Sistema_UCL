   ...
   <main>
      <div class="container">
            ...
            <form action="insert_agenda.php" method="post">
               <div style="margin-top:15px" class="row mb-0">
                  <div class="input-field col s12 m6">
                     <label>Data</label>
                     <input placeholder="Data da Consulta" name="age_data" type="text" class="datepicker" required>
                  </div>

                  <div class="input-field col s12 m6">
                     <label>Horário</label>
                     <input placeholder="Horário da Consulta" name="age_horario" type="text" class="timepicker" required>
                  </div>
         ...
         <div class="card-panel left-div-margin">
            <h2 class="flow-text" style="margin:0 0 5px"><i class="material-icons left">format_list_bulleted</i>Lista de Consultas <a title="Gerar PDF"  href="gerarPDF.php"><i class="material-icons blue-text">archive</i></a></h2>
